<!--
================================================================================
Title:              Section 6.2 README
File Name:          README.md
Relative Path:      sections/6.0_cascading_consequences/6.2_pollinator_collapse/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 6.2: Pollinator Collapse

================================================================================
-->

# Section 6.2: Pollinator Collapse
...
```
6.2_pollinator_collapse/
├── README.md
├── article/
│   ├── article_6.2_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
