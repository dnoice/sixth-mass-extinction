<!--
================================================================================
Title:              Section 6.4 README
File Name:          README.md
Relative Path:      sections/6.0_cascading_consequences/6.4_ecosystem_engineers/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 6.4: Ecosystem Engineers

================================================================================
-->

# Section 6.4: Ecosystem Engineers

## Overview

*Part of 6.0: Cascading Consequences*
...
```
6.4_ecosystem_engineers/
├── README.md
├── article/
│   ├── article_6.4_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
