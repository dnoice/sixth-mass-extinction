<!--
================================================================================
Title:              Section 10.1 README
File Name:          README.md
Relative Path:      sections/10.0_solutions_synthesis/10.1_bending_the_curve/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 10.1: Bending the Curve

================================================================================
-->

# Section 10.1: Bending the Curve
...
```
10.1_bending_the_curve/
├── README.md
├── article/
│   ├── article_10.1_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
