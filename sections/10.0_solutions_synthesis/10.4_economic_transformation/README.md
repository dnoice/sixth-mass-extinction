<!--
================================================================================
Title:              Section 10.4 README
File Name:          README.md
Relative Path:      sections/10.0_solutions_synthesis/10.4_economic_transformation/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 10.4: Economic Transformation

================================================================================
-->

# Section 10.4: Economic Transformation
...
```
10.4_economic_transformation/
├── README.md
├── article/
│   ├── article_10.4_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
