<!--
================================================================================
Title:              Section 9.4 README
File Name:          README.md
Relative Path:      sections/9.0_future_projections/9.4_scenario_modeling/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 9.4: Scenario Modeling

================================================================================
-->

# Section 9.4: Scenario Modeling

## Overview

*Part of 9.0: Future Projections*
...
```
9.4_scenario_modeling/
├── README.md
├── article/
│   ├── article_9.4_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
