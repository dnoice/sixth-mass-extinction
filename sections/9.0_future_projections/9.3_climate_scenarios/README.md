<!--
================================================================================
Title:              Section 9.3 README
File Name:          README.md
Relative Path:      sections/9.0_future_projections/9.3_climate_scenarios/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 9.3: Climate Scenarios

================================================================================
-->

# Section 9.3: Climate Scenarios
...
```
9.3_climate_scenarios/
├── README.md
├── article/
│   ├── article_9.3_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
