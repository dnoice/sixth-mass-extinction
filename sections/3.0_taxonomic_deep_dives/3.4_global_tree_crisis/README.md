<!--
================================================================================
Title:              Section 3.4 README
File Name:          README.md
Relative Path:      sections/3.0_taxonomic_deep_dives/3.4_global_tree_crisis/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 3.4: The Global Tree Crisis

================================================================================
-->

# Section 3.4: The Global Tree Crisis

## Overview

*Part of 3.0: Taxonomic Deep Dives*
...
```
3.4_global_tree_crisis/
├── README.md
├── article/
│   ├── article_3.4_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
