<!--
================================================================================
Title:              Section 3.5 README
File Name:          README.md
Relative Path:      sections/3.0_taxonomic_deep_dives/3.5_coral_catastrophe/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 3.5: The Coral Catastrophe

================================================================================
-->

# Section 3.5: The Coral Catastrophe
...
```
3.5_coral_catastrophe/
├── README.md
├── article/
│   ├── article_3.5_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
