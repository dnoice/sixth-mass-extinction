<!--
================================================================================
Title:              Section 7.2 README
File Name:          README.md
Relative Path:      sections/7.0_economic_reckoning/7.2_agriculture_at_risk/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 7.2: Agriculture at Risk

================================================================================
-->

# Section 7.2: Agriculture at Risk
...
```
7.2_agriculture_at_risk/
├── README.md
├── article/
│   ├── article_7.2_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
