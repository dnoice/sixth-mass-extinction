<!--
================================================================================
Title:              Section 7.3 README
File Name:          README.md
Relative Path:      sections/7.0_economic_reckoning/7.3_pharmaceutical_pipeline/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 7.3: The Pharmaceutical Pipeline

================================================================================
-->

# Section 7.3: The Pharmaceutical Pipeline

## Overview

*Part of 7.0: Economic Reckoning*
...
```
7.3_pharmaceutical_pipeline/
├── README.md
├── article/
│   ├── article_7.3_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
