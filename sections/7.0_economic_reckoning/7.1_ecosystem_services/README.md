<!--
================================================================================
Title:              Section 7.1 README
File Name:          README.md
Relative Path:      sections/7.0_economic_reckoning/7.1_ecosystem_services/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 7.1: Ecosystem Services

================================================================================
-->

# Section 7.1: Ecosystem Services
...
```
7.1_ecosystem_services/
├── README.md
├── article/
│   ├── article_7.1_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
