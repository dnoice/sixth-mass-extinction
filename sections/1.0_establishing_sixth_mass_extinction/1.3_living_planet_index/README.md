<!--
================================================================================
Title:              Section 1.3 README
File Name:          README.md
Relative Path:      sections/1.0_establishing_sixth_mass_extinction/1.3_living_planet_index/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 1.3: Living Planet Index

================================================================================
-->

# Section 1.3: Living Planet Index
...
```
1.3_living_planet_index/
├── README.md
├── article/
│   ├── article_1.3_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
