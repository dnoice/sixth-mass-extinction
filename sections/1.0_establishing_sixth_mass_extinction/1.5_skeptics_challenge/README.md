<!--
================================================================================
Title:              Section 1.5 README
File Name:          README.md
Relative Path:      sections/1.0_establishing_sixth_mass_extinction/1.5_skeptics_challenge/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 1.5: The Skeptics' Challenge

================================================================================
-->

# Section 1.5: The Skeptics' Challenge

## Overview

*Part of 1.0: Establishing the Sixth Mass Extinction*
...
```
1.5_skeptics_challenge/
├── README.md
├── article/
│   ├── article_1.5_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
