<!--
================================================================================
Title:              Section 5.1 README
File Name:          README.md
Relative Path:      sections/5.0_human_fingerprint/5.1_agricultural_expansion/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 5.1: Agricultural Expansion

================================================================================
-->

# Section 5.1: Agricultural Expansion

## Overview

*Part of 5.0: The Human Fingerprint*
...
```
5.1_agricultural_expansion/
├── README.md
├── article/
│   ├── article_5.1_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
