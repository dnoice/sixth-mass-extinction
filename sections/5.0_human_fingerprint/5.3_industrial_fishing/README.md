<!--
================================================================================
Title:              Section 5.3 README
File Name:          README.md
Relative Path:      sections/5.0_human_fingerprint/5.3_industrial_fishing/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 5.3: Industrial Fishing

================================================================================
-->

# Section 5.3: Industrial Fishing
...
```
5.3_industrial_fishing/
├── README.md
├── article/
│   ├── article_5.3_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
