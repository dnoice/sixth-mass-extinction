<!--
================================================================================
Title:              Section 8.2 README
File Name:          README.md
Relative Path:      sections/8.0_conservation_frontlines/8.2_species_recovery/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 8.2: Species Recovery

================================================================================
-->

# Section 8.2: Species Recovery
...
```
8.2_species_recovery/
├── README.md
├── article/
│   ├── article_8.2_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
