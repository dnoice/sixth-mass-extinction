<!--
================================================================================
Title:              Section 8.3 README
File Name:          README.md
Relative Path:      sections/8.0_conservation_frontlines/8.3_ex_situ_conservation/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 8.3: Ex Situ Conservation

================================================================================
-->

# Section 8.3: Ex Situ Conservation

## Overview

*Part of 8.0: Conservation Frontlines*
...
```
8.3_ex_situ_conservation/
├── README.md
├── article/
│   ├── article_8.3_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
