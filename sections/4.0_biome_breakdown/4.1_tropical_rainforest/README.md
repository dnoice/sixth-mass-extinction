<!--
================================================================================
Title:              Section 4.1 README
File Name:          README.md
Relative Path:      sections/4.0_biome_breakdown/4.1_tropical_rainforest/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 4.1: Tropical Rainforest

================================================================================
-->

# Section 4.1: Tropical Rainforest

## Overview

*Part of 4.0: Biome Breakdown*
...
```
4.1_tropical_rainforest/
├── README.md
├── article/
│   ├── article_4.1_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
