<!--
================================================================================
Title:              Section 2.2 README
File Name:          README.md
Relative Path:      sections/2.0_five_horsemen_drivers/2.2_invasive_species/README.md
...
DESCRIPTION:
Overview and reproduction instructions for Section 2.2: Invasive Species

================================================================================
-->

# Section 2.2: Invasive Species

## Overview

*Part of 2.0: The Five Horsemen: Primary Drivers*
...
```
2.2_invasive_species/
├── README.md
├── article/
│   ├── article_2.2_[title].md
│   ├── article_summary.md
│   └── key_findings.md
├── notebooks/
