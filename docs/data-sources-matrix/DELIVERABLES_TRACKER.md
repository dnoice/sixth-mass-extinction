...
| 4.0 Biome Breakdown | 4 | 0 | ░░░░ 0% |
| 5.0 Human Fingerprint | 4 | 0 | ░░░░ 0% |
| 6.0 Cascading Consequences | 4 | 0 | ░░░░ 0% |
| 7.0 Economic Reckoning | 4 | 0 | ░░░░ 0% |
| 8.0 Conservation Frontlines | 4 | 0 | ░░░░ 0% |
| 9.0 Future Projections | 4 | 0 | ░░░░ 0% |
| 10.0 Solutions & Synthesis | 5 | 0 | ░░░░░ 0% |
...
## SECTION 1.0: ESTABLISHING THE SIXTH MASS EXTINCTION
...
| └─ key_findings.md | Summary | ⬜ | ⬜ Review | |
| **Notebooks** | | | | |
| └─ 01_extinction_rate_calculation.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| └─ 02_big_five_comparison.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| └─ 03_rate_visualization.ipynb | Visualization | ⬜ | ⬜ Code Review | |
| **Figures** | | | | |
| └─ fig_1.1_01_extinction_rates.png | Figure | ⬜ | ⬜ Design Review | |
| └─ fig_1.1_02_big_five_comparison.png | Figure | ⬜ | ⬜ Design Review | |
| └─ fig_1.1_03_[TBD].png | Figure | ⬜ | ⬜ Design Review | |
| **Documentation** | | | | |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review | |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review | |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review | |
| **Data** | | | | |
| └─ raw/ (source files) | Data | ⬜ | ⬜ Validation | |
| └─ processed/ (cleaned) | Data | ⬜ | ⬜ Validation | |
| └─ derived/ (novel datasets) | Data | ⬜ | ⬜ Validation | |

**Dependencies**: None (foundation article)
**Blockers**: None
**Data Sources**: DS-PA-001, DS-PA-002, DS-PR-001, DS-PR-002

---

### 1.2 IUCN Red List Deep Dive
...
| └─ key_findings.md | Summary | ⬜ | ⬜ Review | |
| **Notebooks** | | | | |
| └─ 01_red_list_api_data_pull.ipynb | Data | ⬜ | ⬜ Code Review | |
| └─ 02_trend_analysis.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| └─ 03_bias_quantification.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| **Figures** | | | | |
| └─ fig_1.2_01_[TBD].png | Figure | ⬜ | ⬜ Design Review | |
| └─ fig_1.2_02_[TBD].png | Figure | ⬜ | ⬜ Design Review | |
| └─ fig_1.2_03_[TBD].png | Figure | ⬜ | ⬜ Design Review | |
| **Documentation** | | | | |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review | |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review | |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review | |

**Dependencies**: 1.1 complete (for context)
**Blockers**: IUCN API token needed
**Data Sources**: DS-PA-001, DS-PA-002

---

### 1.3 Living Planet Index
...
| └─ key_findings.md | Summary | ⬜ | ⬜ Review | |
| **Notebooks** | | | | |
| └─ 01_lpi_data_extraction.ipynb | Data | ⬜ | ⬜ Code Review | |
| └─ 02_driver_decomposition.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| └─ 03_regional_analysis.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| **Documentation** | | | | |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review | |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review | |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review | |
...
**Blockers**: LPI database access request
**Data Sources**: DS-PA-003
...
| └─ key_findings.md | Summary | ⬜ | ⬜ Review | |
| **Notebooks** | | | | |
| └─ 01_biomass_data_compilation.ipynb | Data | ⬜ | ⬜ Code Review | |
| └─ 02_defaunation_index.ipynb | Analysis | ⬜ | ⬜ Code Review | Novel! |
| └─ 03_functional_extinction_modeling.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| **Documentation** | | | | |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review | |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review | |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review | |
...
**Blockers**: None
**Data Sources**: DS-PA-003, DS-PR-004, DS-PR-005

---

### 1.5 The Skeptics' Challenge
...
| └─ key_findings.md | Summary | ⬜ | ⬜ Review | |
| **Notebooks** | | | | |
| └─ 01_critique_systematic_review.ipynb | Research | ⬜ | ⬜ Code Review | |
| └─ 02_sensitivity_analysis.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| └─ 03_consensus_mapping.ipynb | Analysis | ⬜ | ⬜ Code Review | |
| **Documentation** | | | | |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review | |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review | |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review | |
...
**Blockers**: None
**Data Sources**: DS-PA-001, DS-PR-001, DS-PR-002, critique literature

---

## SECTION 2.0: THE FIVE HORSEMEN - PRIMARY DRIVERS
...
| └─ 03_extinction_debt_calculation.ipynb | Analysis | ⬜ | ⬜ Code Review |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review |

**Dependencies**: Section 1.0 complete
**Data Sources**: DS-PA-007, DS-PR-009
...
| └─ 03_vulnerability_modeling.ipynb | Analysis | ⬜ | ⬜ Code Review |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review |

**Dependencies**: Section 1.0 complete
**Data Sources**: DS-PA-001, GISD
...
| └─ 03_emerging_contaminants.ipynb | Analysis | ⬜ | ⬜ Code Review |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review |

**Dependencies**: Section 1.0 complete
**Data Sources**: UNEP pollution data, literature
...
| └─ 03_sustainable_yield_gap.ipynb | Analysis | ⬜ | ⬜ Code Review |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review |

**Dependencies**: Section 1.0 complete
**Data Sources**: DS-PA-009, DS-PA-010
...
| └─ 03_compound_driver_analysis.ipynb | Analysis | ⬜ | ⬜ Code Review |
| └─ uncertainty_documentation.md | Doc | ⬜ | ⬜ Review |
| └─ methods_original_analysis.md | Doc | ⬜ | ⬜ Tech Review |
| └─ technical_supplement.md | Doc | ⬜ | ⬜ Tech Review |

**Dependencies**: Section 1.0 complete
**Data Sources**: DS-PA-005, climate-extinction literature
...
| M4: Taxonomic Dives Complete | 3.1-3.5 | ⬜ |
| M5: Geographic Complete | 4.1-4.4 | ⬜ |
| M6: Mechanisms Complete | 5.1-6.4 | ⬜ |
| M7: Economics Complete | 7.1-7.4 | ⬜ |
| M8: Conservation Complete | 8.1-8.4 | ⬜ |
| M9: Projections Complete | 9.1-9.4 | ⬜ |
| M10: Full Series Complete | 10.1-10.5 | ⬜ |
